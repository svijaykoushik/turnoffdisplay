...
{
    public partial class aboutTurnoff : Form
    {
        public aboutTurnoff()
        {
            InitializeComponent();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            productVersion.Text = String.Format("Version {0}", AssemblyVersion);
            publsiherName.Text = String.Format("Publisher {0}", AssemblyCompany);
        ...
        public Version AssemblyVersionObject
        {
            get
            {
